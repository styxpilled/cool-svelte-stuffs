...
{#if show}
        ...
        <div>
			<span  style="color:#f080ea" transition:swipeColor={{ delay: 300 }}>Custom Transitions!</span>
		</div>
        <br>
		<div>
			<span  style="color:#fff430" transition:swipeColor={{ delay: 600 }}>you can make cool things with them</span>
		</div>
		<div>
			<span style="color:#ffffff"transition:swipeColor={{ delay: 600 }}>like a cool flag :></span>
		</div>
        <div>
			<span style="color:#9c59d1"transition:swipeColor={{ delay: 600 }}>that matches the text colour</span>
		</div>
        <div>
			<span style="color:#000000"transition:swipeColor={{ delay: 600 }}>black doesn't look great on this background</span>
		</div>
{/if}
